"""
Django settings for taller_whatsapp project.
...
SECRET_KEY = 'django-insecure-i_8!!gdi867a-gj0he7md2^)5iu=aoc=23@(u1d$p725knvx6@'
...
ROOT_URLCONF = 'taller_whatsapp.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # Ruta a la carpeta templates en el directorio raíz
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'taller_whatsapp.wsgi.application'
